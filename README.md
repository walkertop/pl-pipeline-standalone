...
**当前稳定版：`pl-v1.10.0`（2026-04-24 · 加 `pl detect` 扫描+建议；`pl new --here` 默认改为只读 dry-run）**。
...
- 🚧 v1.11+ 路线见 [Issues](https://github.com/walkertop/pl-pipeline-standalone/issues)，未承诺时间
